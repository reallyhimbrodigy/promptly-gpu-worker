  ...
  return (
    <span
      style={{
        ...
        lineHeight: 1.2,
        color,
        // E legibility floor (directive #13 promotion check): the ABE shadow
        // is diffuse-only; the shared anchor rides in front.
        textShadow: `${LEGIBILITY_ANCHOR}, 0 4px 12px rgba(0,0,0,0.55)`,
