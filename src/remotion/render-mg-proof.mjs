...
// Palette like the job's deterministic extractor: near-white ground, dark type,
// a per-job accent. StatCard/Stamp/PillCluster consume these, never a brand value.
const PAL = { number: "#14141A", label: "#14141A", accent: "#8B350D" };
const PROPS = {
...
const inputProps = { type: TYPE, props: PROPS, motionBlur: true };
