...
if (!inputPath || !outputPath) {
  console.error("Usage: node render-full.mjs --input <json> --output <mp4> [--concurrency N] [--gl mode]");
  process.exit(1);
}
...
console.log(`[render-full] selectComposition: ${((Date.now() - tComp) / 1000).toFixed(2)}s`);
