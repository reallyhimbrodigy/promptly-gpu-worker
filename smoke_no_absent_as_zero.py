...
KNOWN = {
    ...
    # A duration of 0 in a report dict IS a false measurement. Mine, and it
    # should go — listed rather than fixed silently mid-round.
    "source_duration_s": "MINE, to fix: absent duration is not a zero duration",
    ...
    # A source with no readable duration is a real problem, but `or 0` here
    # feeds arithmetic that is guarded downstream rather than a printed figure.
    "duration": "ffprobe duration into arithmetic, guarded downstream",
