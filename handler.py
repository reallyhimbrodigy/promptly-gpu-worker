...
B-roll — stock footage cutaways that show what the speaker is describing. B-roll replaces the video (not audio) for its duration — the speaker's voice continues over the footage.
  ...
  The keyword is a Pexels video search query. Write it like a director giving a shot brief to a stock footage house: the subject (age, gender, what they look like), the specific physical action they are performing, the exact location/setting with distinguishing details, the framing (close up, medium shot, wide shot, POV), and the lighting or time of day if relevant. A good keyword is 10-15 words and leaves zero ambiguity about what the clip should show. Pexels indexes millions of clips — vague keywords return random results because they match thousands of videos. The more specific and literal your keyword, the more likely the first result is the exact shot you need. Every word you add filters out irrelevant clips.
