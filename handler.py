...
Follow these patterns for speed ramping, pacing, and cuts only. Do NOT copy the b-roll keyword style from these examples — b-roll keywords must follow the b-roll instructions above.
