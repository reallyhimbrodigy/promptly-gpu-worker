...
Decisions:
  • broll_clips[0]: keyword="vintage ceramic piggy bank coins falling in slow
    ...
    end_word_index=22, reason="visual evidence of the saving while the speaker
    narrates the build"
