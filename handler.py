...
B-roll — stock footage cutaways that show what the speaker is describing. B-roll replaces the video (not audio) for its duration — the speaker's voice continues over the footage.
  ...
  The keyword is a Pexels video search query. Write it like a cinematographer describing a shot: who or what is in frame, what action they are performing, the specific setting, and the camera perspective. A good keyword is 8-12 words and reads like a scene description — "young man lathering shaving cream on face in bathroom mirror medium shot" or "little boy in pajamas sitting cross-legged on bedroom floor playing with toys" or "POV driving fast on empty highway at golden hour through windshield". Each word in the keyword narrows the search. Short generic keywords like "man shaving" or "boy on floor" return thousands of unrelated clips. Long specific keywords return the exact shot you need.
