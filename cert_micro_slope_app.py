...
app = modal.App("cert-micro-slope", image=image)
...
import os as _os
SRC = _os.environ.get("MICRO_SRC") or 'https://d1iax8jos987n3.cloudfront.net/sources/f20412db-9178-460c-b863-c852d03a2a67/1787429541382-9B05448D-58A8-49C2-9963-A167F2E3B0BE_L0_001.mp4'
