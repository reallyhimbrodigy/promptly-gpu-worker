...
app = modal.App("cert-tier1-hindi-e2e", image=image)
...
SRC = "https://d1iax8jos987n3.cloudfront.net/sources/15c392d6-26bf-4838-92c4-40afe386b9e0/1785208983103-930A4D00-CF5D-4337-BB24-0F65D408538F_L0_001.mp4"
...
def run() -> dict:
    ...
    os.environ["PROMPTLY_LANG_ROUTING"] = "1"; os.environ["PROMPTLY_ROUTE_LANGS"] = "hi"
...
def main():
    print("=== TIER-1 HINDI GRADUATION E2E (bb30ffb8: multi 27%-short → Stage A hi) ===")
    o = run.remote()
    assert o, "no result"
    if o.get("error"):
    ...
    SCR = "/private/tmp/claude-501/-Users-zaclibman-promptly-gpu-worker-promptly-gpu-worker/e9b63b3b-7849-46b2-befa-856527c74120/scratchpad/hindi_e2e_frames"
    ...
    print("\n✅ HINDI RECOVERY E2E: rendered (was a TRANSCRIPTION_INCOMPLETE reject before Stage A).")
